...
class SyncStoreTransfersFromStripeJob implements ShouldQueue
{
    ...
    {
        Log::info('Starting sync transfers from Stripe for store', [
        ...
        try {
            ...
            Log::info('Sync transfers from Stripe completed for store', [
                'store_id' => $this->store->id,
                'total' => $result['total'],
            ...
            Log::error('Sync transfers from Stripe job failed for store', [
                'store_id' => $this->store->id,
                'error' => $e->getMessage(),
