...
class SyncStorePaymentIntentsFromStripeJob implements ShouldQueue
{
    ...
    {
        Log::info('Starting sync payment intents from Stripe for store', [
        ...
        try {
            ...
            Log::info('Sync payment intents from Stripe completed for store', [
                'store_id' => $this->store->id,
                'total' => $result['total'],
            ...
            Log::error('Sync payment intents from Stripe job failed for store', [
                'store_id' => $this->store->id,
                'error' => $e->getMessage(),
