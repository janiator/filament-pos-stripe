...
class SyncStorePaymentLinksFromStripeJob implements ShouldQueue
{
    ...
    {
        Log::info('Starting sync payment links from Stripe for store', [
        ...
        try {
            ...
            Log::info('Sync payment links from Stripe completed for store', [
                'store_id' => $this->store->id,
                'total' => $result['total'],
            ...
            Log::error('Sync payment links from Stripe job failed for store', [
                'store_id' => $this->store->id,
                'error' => $e->getMessage(),
