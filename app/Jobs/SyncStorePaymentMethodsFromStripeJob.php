...
class SyncStorePaymentMethodsFromStripeJob implements ShouldQueue
{
    ...
    {
        Log::info('Starting sync payment methods from Stripe for store', [
        ...
        try {
            ...
            Log::info('Sync payment methods from Stripe completed for store', [
                'store_id' => $this->store->id,
                'total' => $result['total'],
            ...
            Log::error('Sync payment methods from Stripe job failed for store', [
                'store_id' => $this->store->id,
                'error' => $e->getMessage(),
