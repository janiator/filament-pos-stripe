...
// - Custom item descriptions for diverse products
...
Future<dynamic> completePosPurchase(
  ...
  try {
    ...
    for (var cartItem in cart.cartItems) {
      ...
      // NOTE: This requires cartItemDescription field to exist in CartItemsStruct
      // If you get a compile error, add the field to CartItemsStruct first
