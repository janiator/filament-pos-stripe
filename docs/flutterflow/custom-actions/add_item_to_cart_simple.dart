// FlutterFlow Custom Action: Add Item to Cart (Simplified Version)
// 
// Copy this code directly into FlutterFlow Custom Action
// Parameters: product (Product), quantity (Integer), variant (ProductVariant, optional)
