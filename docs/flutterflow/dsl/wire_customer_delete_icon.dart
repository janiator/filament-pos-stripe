...
///
/// Source: `docs/flutterflow/custom-actions/delete_connected_customer.dart`
...
File _repoCustomActionFile() {
  ...
  return File(
    '$repoRoot/docs/flutterflow/custom-actions/delete_connected_customer.dart',
  );
}
...
Run from **positiv_flutterflow_ai** (copy from docs/flutterflow/dsl/).
