...
class PcmInternalLibrary extends StatefulWidget {
  const PcmInternalLibrary({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<PcmInternalLibrary> createState() =>
      _PcmInternalLibraryState();
}

class _PcmInternalLibraryState extends State<PcmInternalLibrary> {
  ...
  Future<void> _loadVisibleArticleGroupCodes() async {
    try {
      final uri =
          Uri.parse('${widget.apiBaseUrl}/api/stores/${widget.storeSlug}');
                            ...
                            child: DropdownButtonFormField<String?>(
                              ...
                              items: [
                                ...
                                if (_selectedArticleGroupCode != null &&
                                    !_visibleArticleGroupCodes.any((e) =>
                                        e['code'] == _selectedArticleGroupCode))
