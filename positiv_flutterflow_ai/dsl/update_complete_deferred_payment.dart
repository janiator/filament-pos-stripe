...
///
/// Source: [repo]/generated_code/lib/custom_code/actions/complete_deferred_payment.dart
...
void _printUsage() {
  stdout.writeln('''
Push completeDeferredPayment from generated_code export into FlutterFlow POSitiv.
