...
/// Uses `generated_code/` export first, then FlutterFlow desktop export as fallback.
File _customArtifactSource(String fileName) {
  ...
  if (fileName.endsWith('_library.dart')) {
    final generated = generatedCustomClassSource(fileName);
    if (generated.existsSync()) {
      return generated;
    }
  }
...
/// pos-stripe `generated_code/lib/custom_code/widgets/`).
