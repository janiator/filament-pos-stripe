...
return new class extends Migration
{
    ...
    {
        Schema::create('tripletex_account_mappings', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['tripletex_integration_id', 'basis_type', 'basis_key'], 'tripletex_mapping_integration_basis_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('tripletex_account_mappings');
    }
};
