...
**items** | [**\OpenAPIClient\Model\RefundPurchaseRequestItemsInner[]**](RefundPurchaseRequestItemsInner.md) | Optional array of items being refunded (for item-level tracking) | [optional]
