...
**cart** | [**\OpenAPIClient\Model\PurchaseCart**](PurchaseCart.md) | Final cart when the customer edits the deferred order before payment (optional). Same schema as the &#x60;cart&#x60; object on &#x60;POST /api/purchases&#x60;. Not allowed unless the charge is a deferred pending purchase. When omitted, the original deferred lines and amount are unchanged. | [optional]
