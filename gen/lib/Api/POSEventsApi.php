...
class POSEventsApi
{
    ...
    {
        return $this->listPosEventsAsyncWithHttpInfo($event_code, $event_type, $pos_session_id, $from_date, $to_date, $per_page, $nullinnslag, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
