...
class TerminalsApi
{
     ...
     * @param  \OpenAPI\Client\Model\CreateTerminalConnectionTokenRequest $create_terminal_connection_token_request create_terminal_connection_token_request (optional)
     ...
     *
     * @param  string $store Store ID or slug (required)
     * @param  \OpenAPI\Client\Model\CreateTerminalConnectionTokenRequest $create_terminal_connection_token_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createTerminalConnectionToken'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function createTerminalConnectionTokenWithHttpInfo($store, $create_terminal_connection_token_request = null, string $contentType = self::contentTypes['createTerminalConnectionToken'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CreateTerminalConnectionToken200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CreateTerminalConnectionToken200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CreateTerminalConnectionToken200Response', []),
    ...
    public function createTerminalPaymentIntentWithHttpInfo($store, $create_terminal_payment_intent_request, string $contentType = self::contentTypes['createTerminalPaymentIntent'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\CreateTerminalPaymentIntent201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CreateTerminalPaymentIntent201Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CreateTerminalPaymentIntent201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
    ...
    public function listTerminalLocationsWithHttpInfo(string $contentType = self::contentTypes['listTerminalLocations'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ListTerminalLocations200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ListTerminalLocations200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ListTerminalLocations200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
    ...
    public function listTerminalReadersWithHttpInfo(string $contentType = self::contentTypes['listTerminalReaders'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ListTerminalReaders200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ListTerminalReaders200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ListTerminalReaders200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
