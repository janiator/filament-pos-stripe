...
class WebhooksApi
{
    ...
    /**
     * Operation stripeConnectWebhook
     *
    ...
    {
        $this->stripeConnectWebhookWithHttpInfo($body, $contentType);
    }

    /**
     * Operation stripeConnectWebhookWithHttpInfo
     *
     * Stripe Connect webhook
     *
    ...
    {
        $request = $this->stripeConnectWebhookRequest($body, $contentType);
    ...
    /**
     * Operation stripeConnectWebhookAsync
     *
     * Stripe Connect webhook
     *
     * @param  object $body (required)
    ...
    {
        return $this->stripeConnectWebhookAsyncWithHttpInfo($body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation stripeConnectWebhookAsyncWithHttpInfo
     *
     * Stripe Connect webhook
     *
     * @param  object $body (required)
    ...
    public function stripeConnectWebhookRequest($body, string $contentType = self::contentTypes['stripeConnectWebhook'][0])
    {
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling stripeConnectWebhook'
            );
        }
