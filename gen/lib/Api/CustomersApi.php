...
class CustomersApi
{
     ...
     * @param  string $x_tenant Store slug (optional, defaults to user&#39;s first store) (optional)
     ...
     * List customers
     *
     * @param  int $per_page Number of items per page (optional, default to 15)
     * @param  string $x_tenant Store slug (optional, defaults to user&#39;s first store) (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\PaginatedCustomers|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse
     */
    public function listCustomers($per_page = 15, $x_tenant = null, string $contentType = self::contentTypes['listCustomers'][0])
    {
        list($response) = $this->listCustomersWithHttpInfo($per_page, $x_tenant, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PaginatedCustomers|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listCustomersWithHttpInfo($per_page = 15, $x_tenant = null, string $contentType = self::contentTypes['listCustomers'][0])
    {
        $request = $this->listCustomersRequest($per_page, $x_tenant, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\PaginatedCustomers' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\PaginatedCustomers' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\PaginatedCustomers', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\OpenAPI\Client\Model\PaginatedCustomers';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\PaginatedCustomers',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCustomersAsync($per_page = 15, $x_tenant = null, string $contentType = self::contentTypes['listCustomers'][0])
    {
        return $this->listCustomersAsyncWithHttpInfo($per_page, $x_tenant, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCustomersAsyncWithHttpInfo($per_page = 15, $x_tenant = null, string $contentType = self::contentTypes['listCustomers'][0])
    {
        $returnType = '\OpenAPI\Client\Model\PaginatedCustomers';
        $request = $this->listCustomersRequest($per_page, $x_tenant, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listCustomersRequest($per_page = 15, $x_tenant = null, string $contentType = self::contentTypes['listCustomers'][0])
    {
