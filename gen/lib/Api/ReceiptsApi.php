...
class ReceiptsApi
{
    ...
    public function generateReceiptWithHttpInfo($generate_receipt_request, string $contentType = self::contentTypes['generateReceipt'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\GenerateReceipt201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GenerateReceipt201Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GenerateReceipt201Response', []),
    ...
    public function getReceiptWithHttpInfo($id, string $contentType = self::contentTypes['getReceipt'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetReceipt200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetReceipt200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetReceipt200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * List receipts
     *
     * @param  string $receipt_type Filter by receipt type (optional)
     * @param  int $pos_session_id Filter by POS session ID (optional)
     * @param  bool $printed Filter by printed status (optional)
     ...
     */
    public function listReceipts($receipt_type = null, $pos_session_id = null, $printed = null, $from_date = null, $to_date = null, $per_page = 20, string $contentType = self::contentTypes['listReceipts'][0])
    {
        list($response) = $this->listReceiptsWithHttpInfo($receipt_type, $pos_session_id, $printed, $from_date, $to_date, $per_page, $contentType);
        return $response;
    }
     ...
     */
    public function listReceiptsWithHttpInfo($receipt_type = null, $pos_session_id = null, $printed = null, $from_date = null, $to_date = null, $per_page = 20, string $contentType = self::contentTypes['listReceipts'][0])
    {
        $request = $this->listReceiptsRequest($receipt_type, $pos_session_id, $printed, $from_date, $to_date, $per_page, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ListReceipts200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ListReceipts200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ListReceipts200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listReceiptsAsync($receipt_type = null, $pos_session_id = null, $printed = null, $from_date = null, $to_date = null, $per_page = 20, string $contentType = self::contentTypes['listReceipts'][0])
    {
        return $this->listReceiptsAsyncWithHttpInfo($receipt_type, $pos_session_id, $printed, $from_date, $to_date, $per_page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listReceiptsAsyncWithHttpInfo($receipt_type = null, $pos_session_id = null, $printed = null, $from_date = null, $to_date = null, $per_page = 20, string $contentType = self::contentTypes['listReceipts'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ListReceipts200Response';
        $request = $this->listReceiptsRequest($receipt_type, $pos_session_id, $printed, $from_date, $to_date, $per_page, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listReceiptsRequest($receipt_type = null, $pos_session_id = null, $printed = null, $from_date = null, $to_date = null, $per_page = 20, string $contentType = self::contentTypes['listReceipts'][0])
    {
    ...
    public function markReceiptPrintedWithHttpInfo($id, string $contentType = self::contentTypes['markReceiptPrinted'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\MarkReceiptPrinted200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\MarkReceiptPrinted200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\MarkReceiptPrinted200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function reprintReceiptWithHttpInfo($id, string $contentType = self::contentTypes['reprintReceipt'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ReprintReceipt200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ReprintReceipt200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ReprintReceipt200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
