...
/**
 * ProductVariantsInnerVariantInventory
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ProductVariantsInnerVariantInventory Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ProductVariantsInnerVariantInventory implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Product_variants_inner_variant_inventory';
     ...
     * Sets management
     *
     * @param  string|null  $management  management
     * @return self
     */
    public function setManagement($management)
    {
        if (is_null($management)) {
            array_push($this->openAPINullablesSetToNull, 'management');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('management', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets tracked
     *
     * @param  bool|null  $tracked  True when the Inventory add-on is active, this product has track_inventory enabled, and this variant has inventory_quantity set (null means not tracked).
     * @return self
     */
