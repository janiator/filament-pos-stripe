 ...
 */
class UserResponse implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('current_store', $data ?? [], null);
    ...
    {
        return $this->container['current_store'];
    }
    ...
    public function setCurrentStore($current_store)
    {
        if (is_null($current_store)) {
            throw new \InvalidArgumentException('non-nullable current_store cannot be null');
        }
        $this->container['current_store'] = $current_store;
