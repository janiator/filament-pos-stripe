...
class PurchaseMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'deferred_payment' => 'setDeferredPayment',
    ...
    protected static $getters = [
        ...
        'deferred_payment' => 'getDeferredPayment',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('deferred_payment', $data ?? [], null);
        $this->setIfExists('deferred_reason', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets deferred_payment
     *
     * @return bool|null
     */
    public function getDeferredPayment()
    {
        return $this->container['deferred_payment'];
    }
    ...
    {
        if (is_null($deferred_payment)) {
            throw new \InvalidArgumentException('non-nullable deferred_payment cannot be null');
        }
        $this->container['deferred_payment'] = $deferred_payment;
    ...
    {
        if (is_null($deferred_reason)) {
            throw new \InvalidArgumentException('non-nullable deferred_reason cannot be null');
        }
