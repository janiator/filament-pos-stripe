...
/**
 * ListTerminalReaders200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListTerminalReaders200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listTerminalReaders_200_response';
    ...
    protected static $openAPITypes = [
        'readers' => '\OpenAPI\Client\Model\TerminalReader[]'
    ];
    ...
    {
        $this->setIfExists('readers', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets readers
     *
     * @return \OpenAPI\Client\Model\TerminalReader[]|null
     */
     ...
     * Sets readers
     *
     * @param \OpenAPI\Client\Model\TerminalReader[]|null $readers readers
     *
     * @return self
     */
    ...
    {
        if (is_null($readers)) {
            throw new \InvalidArgumentException('non-nullable readers cannot be null');
        }
