...
/**
 * ListTerminalLocations200ResponseLastConnected
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ListTerminalLocations200ResponseLastConnected Class Doc Comment
 *
 * @category Class
 *
 * @description Present when device_identifier was sent and device has a last-connected terminal
 *
 * @author   OpenAPI Generator team
 *
 * @link     https://openapi-generator.tech
 ...
 */
class ListTerminalLocations200ResponseLastConnected implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'listTerminalLocations_200_response_last_connected';
    ...
    protected static array $openAPINullables = [
        'location_id' => false,
        'stripe_location_id' => false,
        'location_display_name' => false,
        'reader_id' => false,
    ...
    public function setStripeLocationId($stripe_location_id)
    {
        if (is_null($stripe_location_id)) {
            throw new \InvalidArgumentException('non-nullable stripe_location_id cannot be null');
        }
    ...
    public function setLocationDisplayName($location_display_name)
    {
        if (is_null($location_display_name)) {
            throw new \InvalidArgumentException('non-nullable location_display_name cannot be null');
        }
    ...
    public function setReaderId($reader_id)
    {
        if (is_null($reader_id)) {
            throw new \InvalidArgumentException('non-nullable reader_id cannot be null');
        }
    ...
    public function setStripeReaderId($stripe_reader_id)
    {
        if (is_null($stripe_reader_id)) {
            throw new \InvalidArgumentException('non-nullable stripe_reader_id cannot be null');
        }
    ...
    public function setReaderLabel($reader_label)
    {
        if (is_null($reader_label)) {
            throw new \InvalidArgumentException('non-nullable reader_label cannot be null');
        }
