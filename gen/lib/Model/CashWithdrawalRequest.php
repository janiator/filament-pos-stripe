...
/**
 * CashWithdrawalRequest Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class CashWithdrawalRequest implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'cashWithdrawal_request';
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CashWithdrawalRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets reason
     *
     * @param  string|null  $reason  Optional reason for the withdrawal
     * @return self
     */
    public function setReason($reason)
    {
        ...
        if (! is_null($reason) && (mb_strlen($reason) > 500)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling CashWithdrawalRequest., must be smaller than or equal to 500.');
        }
