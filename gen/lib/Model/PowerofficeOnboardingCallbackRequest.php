...
/**
 * PowerofficeOnboardingCallbackRequest
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PowerofficeOnboardingCallbackRequest Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class PowerofficeOnboardingCallbackRequest implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'powerofficeOnboardingCallback_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('onboarding_token', $data ?? [], null);
    }
    ...
    {
        if (is_null($onboarding_token)) {
            throw new \InvalidArgumentException('non-nullable onboarding_token cannot be null');
        }
