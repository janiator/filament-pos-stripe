<?php
/**
 * VoidTransaction200ResponseCharge
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * VoidTransaction200ResponseCharge Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VoidTransaction200ResponseCharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'voidTransaction_200_response_charge';
    ...
    */
    ...
    public function setStripeChargeId($stripe_charge_id)
    {
        if (is_null($stripe_charge_id)) {
            throw new \InvalidArgumentException('non-nullable stripe_charge_id cannot be null');
        }
