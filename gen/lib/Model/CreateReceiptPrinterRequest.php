...
/**
 * CreateReceiptPrinterRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateReceiptPrinterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createReceiptPrinter_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('paper_width', $data ?? [], '80');
        $this->setIfExists('connection_type', $data ?? [], null);
        $this->setIfExists('ip_address', $data ?? [], null);
        $this->setIfExists('port', $data ?? [], 9100);
        $this->setIfExists('device_id', $data ?? [], 'local_printer');
        $this->setIfExists('use_https', $data ?? [], false);
        $this->setIfExists('timeout', $data ?? [], 60000);
        $this->setIfExists('is_active', $data ?? [], true);
        $this->setIfExists('monitor_status', $data ?? [], false);
        $this->setIfExists('drawer_open_level', $data ?? [], 'low');
        $this->setIfExists('use_job_id', $data ?? [], false);
    ...
    */
    ...
    public function setPort($port)
    {
        ...
        if (($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling CreateReceiptPrinterRequest., must be smaller than or equal to 65535.');
        }
        if (($port < 1)) {
            throw new \InvalidArgumentException('invalid value for $port when calling CreateReceiptPrinterRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTimeout($timeout)
    {
        ...
        if (($timeout > 300000)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling CreateReceiptPrinterRequest., must be smaller than or equal to 300000.');
        }
        if (($timeout < 1000)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling CreateReceiptPrinterRequest., must be bigger than or equal to 1000.');
        }
     ...
     * Sets pos_device_id
     *
     * @param int|null $pos_device_id Optional POS device to associate with this printer
     *
     * @return self
     */
