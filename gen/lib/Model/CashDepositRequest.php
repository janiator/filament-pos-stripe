...
/**
 * CashDepositRequest Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class CashDepositRequest implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'cashDeposit_request';
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CashDepositRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets reason
     *
     * @param  string|null  $reason  Optional reason for the deposit
     * @return self
     */
    public function setReason($reason)
    {
        ...
        if (! is_null($reason) && (mb_strlen($reason) > 500)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling CashDepositRequest., must be smaller than or equal to 500.');
        }
