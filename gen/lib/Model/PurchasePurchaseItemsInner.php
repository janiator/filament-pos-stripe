...
class PurchasePurchaseItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'purchase_item_description' => true,
    ...
    protected static $attributeMap = [
        ...
        'purchase_item_description' => 'purchase_item_description',
    ...
    protected static $setters = [
        ...
        'purchase_item_description' => 'setPurchaseItemDescription',
    ...
    protected static $getters = [
        ...
        'purchase_item_description' => 'getPurchaseItemDescription',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('purchase_item_description', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets purchase_item_description
     *
     * @return string|null
     */
    public function getPurchaseItemDescription()
    {
        return $this->container['purchase_item_description'];
    }
    ...
    {
        if (is_null($purchase_item_description)) {
            array_push($this->openAPINullablesSetToNull, 'purchase_item_description');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
        ...
        $this->container['purchase_item_description'] = $purchase_item_description;
    ...
    public function setPurchaseItemQuantity($purchase_item_quantity)
    {
        ...
        if (($purchase_item_quantity < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $purchase_item_quantity when calling PurchasePurchaseItemsInner., must be bigger than or equal to 0.01.');
        }
