...
/**
 * VerifoneTerminal Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class VerifoneTerminal implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'VerifoneTerminal';
    ...
    protected static $setters = [
        ...
        'site_entity_id' => 'setSiteEntityId',
    ...
    protected static $getters = [
        ...
        'site_entity_id' => 'getSiteEntityId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('site_entity_id', $data ?? [], null);
     ...
     *
     * @param  string|null  $terminal_identifier  terminal_identifier
     * @return self
     */
     ...
     * @return string|null
     */
    public function getSiteEntityId()
    {
        return $this->container['site_entity_id'];
    }

    /**
     * Sets site_entity_id
     *
     * @param  string|null  $site_entity_id  site_entity_id
     * @return self
     */
    public function setSiteEntityId($site_entity_id)
    {
        if (is_null($site_entity_id)) {
            array_push($this->openAPINullablesSetToNull, 'site_entity_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('site_entity_id', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['site_entity_id'] = $site_entity_id;
