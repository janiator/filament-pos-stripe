...
/**
 * GenerateSafTRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GenerateSafTRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generateSafT_request';
    ...
    */
     ...
     * Sets from_date
     *
     * @param \DateTime $from_date Start date (YYYY-MM-DD)
     *
     * @return self
     */
     ...
     * Sets to_date
     *
     * @param \DateTime $to_date End date (YYYY-MM-DD, must be >= from_date)
     *
     * @return self
     */
