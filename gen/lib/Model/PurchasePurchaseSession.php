...
/**
 * PurchasePurchaseSession Class Doc Comment
 *
 * @category Class
 ...
 */
class PurchasePurchaseSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Purchase_purchase_session';
    ...
    */
    ...
    public function setOpenedAt($opened_at)
    {
        if (is_null($opened_at)) {
            array_push($this->openAPINullablesSetToNull, 'opened_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('opened_at', $nullablesSetToNull);
            if ($index !== FALSE) {
