...
/**
 * BulkUpdateInventoryRequestVariantsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * BulkUpdateInventoryRequestVariantsInner Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class BulkUpdateInventoryRequestVariantsInner implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'bulkUpdateInventory_request_variants_inner';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling BulkUpdateInventoryRequestVariantsInner., must be bigger than or equal to 0.');
        }
