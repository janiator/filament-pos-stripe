...
/**
 * TripletexSyncRetry200Response Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class TripletexSyncRetry200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'tripletexSyncRetry_200_response';
    ...
    protected static $attributeMap = [
        ...
        'store_stripe_payout_id' => 'store_stripe_payout_id',
    ];
    ...
    protected static $setters = [
        ...
        'store_stripe_payout_id' => 'setStoreStripePayoutId',
    ];
    ...
    protected static $getters = [
        ...
        'store_stripe_payout_id' => 'getStoreStripePayoutId',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('store_stripe_payout_id', $data ?? [], null);
    }
    ...
    /**
     * Gets store_stripe_payout_id
     *
     * @return int|null
     */
    public function getStoreStripePayoutId()
    {
        return $this->container['store_stripe_payout_id'];
    }

    /**
     * Sets store_stripe_payout_id
     *
     * @param  int|null  $store_stripe_payout_id  store_stripe_payout_id
     * @return self
     */
    public function setStoreStripePayoutId($store_stripe_payout_id)
    {
        if (is_null($store_stripe_payout_id)) {
            array_push($this->openAPINullablesSetToNull, 'store_stripe_payout_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('store_stripe_payout_id', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['store_stripe_payout_id'] = $store_stripe_payout_id;
