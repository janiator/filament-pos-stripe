    ...
    */
    ...
    public function setVariantPrice($variant_price)
    {
        if (is_null($variant_price)) {
            throw new \InvalidArgumentException('non-nullable variant_price cannot be null');
        }
    ...
    /**
     * Gets no_price_in_pos
     *
     * @return bool|null
     */
    public function getNoPriceInPos()
    {
        return $this->container['no_price_in_pos'];
    }
    ...
    {
        if (is_null($no_price_in_pos)) {
            throw new \InvalidArgumentException('non-nullable no_price_in_pos cannot be null');
        }
        $this->container['no_price_in_pos'] = $no_price_in_pos;
