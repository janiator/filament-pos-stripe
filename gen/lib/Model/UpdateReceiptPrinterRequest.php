...
class UpdateReceiptPrinterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setPort($port)
    {
        ...
        if (($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling UpdateReceiptPrinterRequest., must be smaller than or equal to 65535.');
        }
        if (($port < 1)) {
            throw new \InvalidArgumentException('invalid value for $port when calling UpdateReceiptPrinterRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTimeout($timeout)
    {
        ...
        if (($timeout > 300000)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling UpdateReceiptPrinterRequest., must be smaller than or equal to 300000.');
        }
        if (($timeout < 1000)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling UpdateReceiptPrinterRequest., must be bigger than or equal to 1000.');
        }
