 ...
 */
class CreatePosEvent201Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'message' => 'string',
        'event' => '\OpenAPIClient\Model\PosEvent',
    ];
     ...
     * Sets event
     *
     * @param  \OpenAPIClient\Model\PosEvent|null  $event  event
     * @return self
     */
