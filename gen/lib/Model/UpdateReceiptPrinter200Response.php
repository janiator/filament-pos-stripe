...
/**
 * UpdateReceiptPrinter200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateReceiptPrinter200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateReceiptPrinter_200_response';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('printer', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($printer)) {
            throw new \InvalidArgumentException('non-nullable printer cannot be null');
        }
