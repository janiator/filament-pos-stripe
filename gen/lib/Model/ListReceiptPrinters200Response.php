...
/**
 * ListReceiptPrinters200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListReceiptPrinters200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listReceiptPrinters_200_response';
    ...
    protected static $openAPITypes = [
        'printers' => '\OpenAPI\Client\Model\ReceiptPrinter[]'
    ];
    ...
    {
        $this->setIfExists('printers', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets printers
     *
     * @param \OpenAPI\Client\Model\ReceiptPrinter[]|null $printers printers
     *
     * @return self
     */
    ...
    {
        if (is_null($printers)) {
            throw new \InvalidArgumentException('non-nullable printers cannot be null');
        }
