 ...
 * @category Class
 *
 * @description Pagination metadata. Page numbers are 0-based for FlutterFlow infinite scroll.
 *
 * @author   OpenAPI Generator team
 *
 * @link     https://openapi-generator.tech
 ...
 */
class PaginationMeta implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * Sets current_page
     *
     * @param  int|null  $current_page  Current page index (0-based)
     * @return self
     */
     ...
     * Sets last_page
     *
     * @param  int|null  $last_page  Last page index (0-based)
     * @return self
     */
