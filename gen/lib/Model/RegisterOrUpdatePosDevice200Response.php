...
/**
 * RegisterOrUpdatePosDevice200Response Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class RegisterOrUpdatePosDevice200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'registerOrUpdatePosDevice_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_new_device', $data ?? [], null);
    }
    ...
    {
        return $this->container['is_new_device'];
    }

    /**
     * Sets is_new_device
     *
     * @param  bool|null  $is_new_device  is_new_device
     * @return self
     */
    public function setIsNewDevice($is_new_device)
    {
        if (is_null($is_new_device)) {
            throw new \InvalidArgumentException('non-nullable is_new_device cannot be null');
        }
        $this->container['is_new_device'] = $is_new_device;
