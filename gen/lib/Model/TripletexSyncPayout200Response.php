...
/**
 * TripletexSyncPayout200Response
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * TripletexSyncPayout200Response Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class TripletexSyncPayout200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'tripletexSyncPayout_200_response';
    ...
    public function setStoreStripePayoutId($store_stripe_payout_id)
    {
        if (is_null($store_stripe_payout_id)) {
            throw new \InvalidArgumentException('non-nullable store_stripe_payout_id cannot be null');
        }
