<?php
/**
 * BulkUpdateInventoryRequestUpdatesInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * BulkUpdateInventoryRequestUpdatesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BulkUpdateInventoryRequestUpdatesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bulkUpdateInventory_request_updates_inner';
    ...
    public const INVENTORY_POLICY_DENY = 'deny';
    public const INVENTORY_POLICY__CONTINUE = 'continue';
    ...
    {
        return [
            self::INVENTORY_POLICY_DENY,
            self::INVENTORY_POLICY__CONTINUE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('inventory_management', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['inventory_quantity']) && ($this->container['inventory_quantity'] < 0)) {
            $invalidProperties[] = "invalid value for 'inventory_quantity', must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['inventory_management']) && (mb_strlen($this->container['inventory_management']) > 255)) {
            $invalidProperties[] = "invalid value for 'inventory_management', the character length must be smaller than or equal to 255.";
        }
     ...
     *
     * @param int|null $inventory_quantity inventory_quantity
     *
     * @return self
     */
    public function setInventoryQuantity($inventory_quantity)
    {
        ...
        if (!is_null($inventory_quantity) && ($inventory_quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $inventory_quantity when calling BulkUpdateInventoryRequestUpdatesInner., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $inventory_policy inventory_policy
     *
     * @return self
     */
     ...
     *
     * @param string|null $inventory_management inventory_management
     *
     * @return self
     */
    public function setInventoryManagement($inventory_management)
    {
        if (is_null($inventory_management)) {
            array_push($this->openAPINullablesSetToNull, 'inventory_management');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('inventory_management', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($inventory_management) && (mb_strlen($inventory_management) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory_management when calling BulkUpdateInventoryRequestUpdatesInner., must be smaller than or equal to 255.');
        }
