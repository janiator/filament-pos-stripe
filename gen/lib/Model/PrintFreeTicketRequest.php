...
/**
 * PrintFreeTicketRequest Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class PrintFreeTicketRequest implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'printFreeTicket_request';
    ...
    public function setMaxTickets($max_tickets)
    {
        if (is_null($max_tickets)) {
            array_push($this->openAPINullablesSetToNull, 'max_tickets');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('max_tickets', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
