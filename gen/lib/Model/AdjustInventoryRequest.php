...
/**
 * AdjustInventoryRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdjustInventoryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'adjustInventory_request';
    ...
    */
     ...
     * Sets quantity
     *
     * @param int $quantity Amount to adjust (positive to add, negative to subtract)
     *
     * @return self
     */
    ...
    public function setReason($reason)
    {
        ...
        if (!is_null($reason) && (mb_strlen($reason) > 255)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling AdjustInventoryRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $note when calling AdjustInventoryRequest., must be smaller than or equal to 1000.');
        }
