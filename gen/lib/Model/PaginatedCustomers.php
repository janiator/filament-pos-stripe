...
/**
 * PaginatedCustomers Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedCustomers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedCustomers';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\Customer[]',
        'current_page' => 'int',
        'per_page' => 'int',
        'total' => 'int',
        'last_page' => 'int',
    ...
    */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Customer[]|null $data data
     *
     * @return self
     */
