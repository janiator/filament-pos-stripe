 ...
 */
class ValidationErrorResponse implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * Sets message
     *
     * @param  string|null  $message  Human-readable summary (same locale as API; typically mirrors the first error or a short rollup).
     * @return self
     */
