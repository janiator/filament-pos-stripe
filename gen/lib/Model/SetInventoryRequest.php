...
/**
 * SetInventoryRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SetInventoryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'setInventory_request';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling SetInventoryRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets reason
     *
     * @param string|null $reason Reason for setting quantity
     *
     * @return self
     */
    public function setReason($reason)
    {
        ...
        if (!is_null($reason) && (mb_strlen($reason) > 255)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling SetInventoryRequest., must be smaller than or equal to 255.');
        }
