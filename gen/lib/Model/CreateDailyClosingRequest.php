...
/**
 * CreateDailyClosingRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateDailyClosingRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createDailyClosing_request';
    ...
    */
     ...
     * Sets closing_date
     *
     * @param \DateTime $closing_date Date for daily closing (YYYY-MM-DD)
     *
     * @return self
     */
     ...
     * Sets notes
     *
     * @param string|null $notes Closing notes
     *
     * @return self
     */
    public function setNotes($notes)
    {
        ...
        if (!is_null($notes) && (mb_strlen($notes) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling CreateDailyClosingRequest., must be smaller than or equal to 1000.');
        }
