...
/**
 * RefundPurchaseRequestItemsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RefundPurchaseRequestItemsInner Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class RefundPurchaseRequestItemsInner implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'refundPurchase_request_items_inner';
     ...
     * Sets item_id
     *
     * @param  string|null  $item_id  Purchase item ID
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param  float|null  $quantity  Quantity to refund (supports decimals, e.g. 1.5 kg), same semantics as cart line `quantity`.
     * @return self
     */
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling RefundPurchaseRequestItemsInner., must be bigger than or equal to 0.01.');
        }
