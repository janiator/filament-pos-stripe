...
/**
 * CancelPurchaseRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CancelPurchaseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cancelPurchase_request';
    ...
    */
    ...
    public function setReason($reason)
    {
        ...
        if ((mb_strlen($reason) > 500)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling CancelPurchaseRequest., must be smaller than or equal to 500.');
        }
